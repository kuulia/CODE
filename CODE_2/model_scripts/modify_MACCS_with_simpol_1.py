...
def main():
    ...
    #load simpol groups
    data_simpol_raw = pd.read_csv(path.join(filepath, 'all_smiles_simpol_groups.csv'))
    #print(data_simpol_raw)

    potential_simpol_groups = pd.read_csv(path.join(filepath, 'potential_simpol_groups.csv'))
    groups = potential_simpol_groups['Compound']
