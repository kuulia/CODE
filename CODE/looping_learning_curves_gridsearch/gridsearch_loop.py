...
testname =  'test_' + str(test_size) + '_cm_' + target + '_' + kernel +'_' + version + '.txt'
target_testname = 'test_' +  str(test_size) + '_' + target + '_' + kernel + '_' + version + '.txt'

samplename = str(train_size) +'_cm_' + target + '_' + kernel + '_' + version +  '.txt'
target_samplename = str(train_size) + '_' + target + '_' + kernel + '_' + version + '.txt'
